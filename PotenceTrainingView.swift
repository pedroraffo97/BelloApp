        ...
        VStack {
            List{
                ForEach(data.potence_exercises) {exercise in
                    ...
                    data.potence_exercises.remove(atOffsets: indexSet)
                })
                NavigationLink("Add a new exercise"){
                    AddPotenceExerciseView().navigationTitle("New exercise")
                }
...
struct PotenceTrainingView_previews: PreviewProvider {
